...
TString term1 = " DsVertex.position.x * ( DsVertex.covMatrix[0] * DsVertex.position.x + DsVertex.covMatrix[1] * DsVertex.position.y + DsVertex.covMatrix[2] * DsVertex.position.z ) " ;
TString term2 = " DsVertex.position.y * ( DsVertex.covMatrix[1] * DsVertex.position.x + DsVertex.covMatrix[3] * DsVertex.position.y + DsVertex.covMatrix[4] * DsVertex.position.z ) " ;
TString term3 = " DsVertex.position.z * ( DsVertex.covMatrix[2] * DsVertex.position.x + DsVertex.covMatrix[4] * DsVertex.position.y + DsVertex.covMatrix[5] * DsVertex.position.z ) ";
...
TString bterm1 = " BsVertex_Cov.position.x * ( BsVertex_Cov.covMatrix[0] * BsVertex_Cov.position.x + BsVertex_Cov.covMatrix[1] * BsVertex_Cov.position.y + BsVertex_Cov.covMatrix[2] * BsVertex_Cov.position.z ) " ;
TString bterm2 = " BsVertex_Cov.position.y * ( BsVertex_Cov.covMatrix[1] * BsVertex_Cov.position.x + BsVertex_Cov.covMatrix[3] * BsVertex_Cov.position.y + BsVertex_Cov.covMatrix[4] * BsVertex_Cov.position.z ) " ;
TString bterm3 = " BsVertex_Cov.position.z * ( BsVertex_Cov.covMatrix[2] * BsVertex_Cov.position.x + BsVertex_Cov.covMatrix[4] * BsVertex_Cov.position.y + BsVertex_Cov.covMatrix[5] * BsVertex_Cov.position.z ) ";
