...
class analysis():
	...
	def run(self):
		...
		#OVERVIEW: Accessing different objects and counting them
                ...
                .Define("GenALP_PID", "FCCAnalyses::MCParticle::sel_pdgID(9000005, false)(Particle)")
                .Define("GenALP_decay", "FCCAnalyses::MCParticle::get_list_of_particles_from_decay(0, GenALP_PID, Particle1)")

                .Define("All_n_GenALP", "FCCAnalyses::MCParticle::get_n(GenALP_PID)")
                .Define("AllGenALP_mass", "FCCAnalyses::MCParticle::get_mass(GenALP_PID)") #finding the generator mass of the ALP through separate ALP branch
                .Define("AllGenALP_e", "FCCAnalyses::MCParticle::get_e(GenALP_PID)")
                .Define("AllGenALP_p", "FCCAnalyses::MCParticle::get_p(GenALP_PID)")
                .Define("AllGenALP_pt", "FCCAnalyses::MCParticle::get_pt(GenALP_PID)")    #finding the pt of the ALP thorugh separate ALP branch
                .Define("AllGenALP_px", "FCCAnalyses::MCParticle::get_px(GenALP_PID)")
                .Define("AllGenALP_py", "FCCAnalyses::MCParticle::get_py(GenALP_PID)")
                .Define("AllGenALP_pz", "FCCAnalyses::MCParticle::get_pz(GenALP_PID)")
                .Define("AllGenALP_eta", "FCCAnalyses::MCParticle::get_eta(GenALP_PID)")
                .Define("AllGenALP_theta", "FCCAnalyses::MCParticle::get_theta(GenALP_PID)")
                .Define("AllGenALP_phi", "FCCAnalyses::MCParticle::get_phi(GenALP_PID)")
                .Define("AllGenALP_genStatus", "FCCAnalyses::MCParticle::get_genStatus(GenALP_PID)")

                #all final state gen electrons
                .Define("GenElectron_PID", "FCCAnalyses::MCParticle::sel_pdgID(11, false)(Particle)") #get MCParticle electrons, but not their charge conjugates
                ...
                .Define("GenPositron_PID", "FCCAnalyses::MCParticle::sel_pdgID(-11, false)(Particle)")
                .Define("FSGenPositron", "FCCAnalyses::MCParticle::sel_genStatus(1)(GenPositron_PID)") #gen status==1 means final state particle (FS)
                .Define("n_FSGenPositron", "FCCAnalyses::MCParticle::get_n(FSGenPositron)")
                .Define("FSGenPositron_e", "FCCAnalyses::MCParticle::get_e(FSGenPositron)")
                .Define("FSGenPositron_p", "FCCAnalyses::MCParticle::get_p(FSGenPositron)")
                .Define("FSGenPositron_pt", "FCCAnalyses::MCParticle::get_pt(FSGenPositron)")
                .Define("FSGenPositron_px", "FCCAnalyses::MCParticle::get_px(FSGenPositron)")
                .Define("FSGenPositron_py", "FCCAnalyses::MCParticle::get_py(FSGenPositron)")
                .Define("FSGenPositron_pz", "FCCAnalyses::MCParticle::get_pz(FSGenPositron)")
                .Define("FSGenPositron_eta", "FCCAnalyses::MCParticle::get_eta(FSGenPositron)")
                .Define("FSGenPositron_theta", "FCCAnalyses::MCParticle::get_theta(FSGenPositron)")
                .Define("FSGenPositron_phi", "FCCAnalyses::MCParticle::get_phi(FSGenPositron)")

                #all final state gen neutrinos
                .Define("GenNeutrino_PID", "FCCAnalyses::MCParticle::sel_pdgID(12, false)(Particle)")
                ...
                .Define("GenAntiNeutrino_PID", "FCCAnalyses::MCParticle::sel_pdgID(-12, false)(Particle)")
                .Define("FSGenAntiNeutrino", "FCCAnalyses::MCParticle::sel_genStatus(1)(GenAntiNeutrino_PID)") #gen status==1 means final state particle (FS)
                .Define("n_FSGenAntiNeutrino", "FCCAnalyses::MCParticle::get_n(FSGenAntiNeutrino)")
                .Define("FSGenAntiNeutrino_e", "FCCAnalyses::MCParticle::get_e(FSGenAntiNeutrino)")
                .Define("FSGenAntiNeutrino_p", "FCCAnalyses::MCParticle::get_p(FSGenAntiNeutrino)")
                .Define("FSGenAntiNeutrino_pt", "FCCAnalyses::MCParticle::get_pt(FSGenAntiNeutrino)")
                .Define("FSGenAntiNeutrino_px", "FCCAnalyses::MCParticle::get_px(FSGenAntiNeutrino)")
                .Define("FSGenAntiNeutrino_py", "FCCAnalyses::MCParticle::get_py(FSGenAntiNeutrino)")
                .Define("FSGenAntiNeutrino_pz", "FCCAnalyses::MCParticle::get_pz(FSGenAntiNeutrino)")
                .Define("FSGenAntiNeutrino_eta", "FCCAnalyses::MCParticle::get_eta(FSGenAntiNeutrino)")
                .Define("FSGenAntiNeutrino_theta", "FCCAnalyses::MCParticle::get_theta(FSGenAntiNeutrino)")
                .Define("FSGenAntiNeutrino_phi", "FCCAnalyses::MCParticle::get_phi(FSGenAntiNeutrino)")
                ...
                .Define("FSGenPhoton_vertex_x", "FCCAnalyses::MCParticle::get_vertex_x( FSGenPhoton )")
                .Define("FSGenPhoton_vertex_y", "FCCAnalyses::MCParticle::get_vertex_y( FSGenPhoton )")
                .Define("FSGenPhoton_vertex_z", "FCCAnalyses::MCParticle::get_vertex_z( FSGenPhoton )")
                ...
                .Define("GenALP_indices", "FCCAnalyses::MCParticle::get_indices(9000005, {22, 22}, true, false, false, true)(Particle, Particle1)")
                ...
                .Define("GenALP_mass", "FCCAnalyses::MCParticle::get_mass( GenALP )")
                .Define("GenALP_e", "FCCAnalyses::MCParticle::get_e( GenALP )")
                .Define("GenALP_p", "FCCAnalyses::MCParticle::get_p( GenALP )")
                .Define("GenALP_pt", "FCCAnalyses::MCParticle::get_pt( GenALP )")
                .Define("GenALP_px", "FCCAnalyses::MCParticle::get_px( GenALP )")
                .Define("GenALP_py", "FCCAnalyses::MCParticle::get_py( GenALP )")
                .Define("GenALP_pz", "FCCAnalyses::MCParticle::get_pz( GenALP )")
                .Define("GenALP_eta", "FCCAnalyses::MCParticle::get_eta( GenALP )")
                .Define("GenALP_theta", "FCCAnalyses::MCParticle::get_theta( GenALP )")
                .Define("GenALP_phi", "FCCAnalyses::MCParticle::get_phi( GenALP )")
                .Define("GenALP_genStatus", "FCCAnalyses::MCParticle::get_genStatus( GenALP )")

                # Finding the kinematics of each of these daughters
                .Define("GenALPPhoton1_e", "FCCAnalyses::MCParticle::get_e( GenALPPhoton1 )")
                .Define("GenALPPhoton2_e", "FCCAnalyses::MCParticle::get_e( GenALPPhoton2 )")
                .Define("GenALPPhoton1_p", "FCCAnalyses::MCParticle::get_p( GenALPPhoton1 )")
                .Define("GenALPPhoton2_p", "FCCAnalyses::MCParticle::get_p( GenALPPhoton2 )")
                .Define("GenALPPhoton1_pt", "FCCAnalyses::MCParticle::get_pt( GenALPPhoton1 )")
                .Define("GenALPPhoton2_pt", "FCCAnalyses::MCParticle::get_pt( GenALPPhoton2 )")
                .Define("GenALPPhoton1_px", "FCCAnalyses::MCParticle::get_px( GenALPPhoton1 )")
                .Define("GenALPPhoton2_px", "FCCAnalyses::MCParticle::get_px( GenALPPhoton2 )")
                .Define("GenALPPhoton1_py", "FCCAnalyses::MCParticle::get_py( GenALPPhoton1 )")
                .Define("GenALPPhoton2_py", "FCCAnalyses::MCParticle::get_py( GenALPPhoton2 )")
                .Define("GenALPPhoton1_pz", "FCCAnalyses::MCParticle::get_pz( GenALPPhoton1 )")
                .Define("GenALPPhoton2_pz", "FCCAnalyses::MCParticle::get_pz( GenALPPhoton2 )")
                .Define("GenALPPhoton1_eta", "FCCAnalyses::MCParticle::get_eta( GenALPPhoton1 )")
                .Define("GenALPPhoton2_eta", "FCCAnalyses::MCParticle::get_eta( GenALPPhoton2 )")
                .Define("GenALPPhoton1_theta", "FCCAnalyses::MCParticle::get_theta( GenALPPhoton1 )")
                .Define("GenALPPhoton2_theta", "FCCAnalyses::MCParticle::get_theta( GenALPPhoton2 )")
                .Define("GenALPPhoton1_phi", "FCCAnalyses::MCParticle::get_phi( GenALPPhoton1 )")
                .Define("GenALPPhoton2_phi", "FCCAnalyses::MCParticle::get_phi( GenALPPhoton2 )")
                .Define("GenALPPhoton1_genStatus", "FCCAnalyses::MCParticle::get_genStatus( GenALPPhoton1 )")
                .Define("GenALPPhoton2_genStatus", "FCCAnalyses::MCParticle::get_genStatus( GenALPPhoton2 )")

                # Finding the production vertex of the daughters (checking GenALPPhoton1 here)
                .Define("GenALPPhoton1_vertex_x", "FCCAnalyses::MCParticle::get_vertex_x( GenALPPhoton1 )")
                .Define("GenALPPhoton1_vertex_y", "FCCAnalyses::MCParticle::get_vertex_y( GenALPPhoton1 )")
                .Define("GenALPPhoton1_vertex_z", "FCCAnalyses::MCParticle::get_vertex_z( GenALPPhoton1 )")
                ...
                .Define("GenALP_vertex_x", "FCCAnalyses::MCParticle::get_vertex_x(GenALP_PID)")
                .Define("GenALP_vertex_y", "FCCAnalyses::MCParticle::get_vertex_y(GenALP_PID)")
                .Define("GenALP_vertex_z", "FCCAnalyses::MCParticle::get_vertex_z(GenALP_PID)")
