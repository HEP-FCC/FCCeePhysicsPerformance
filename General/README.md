...
-->
  - See [here for information about the files made with IDEA](https://fcc-physics-events.web.cern.ch/fcc-ee/rec/spring2021/IDEA?q=sim-type%3Ddelphes)
  - The event files can be found in EOS /eos/experiment/fcc/ee/generation/DelphesEvents/spring2021
  - a few files were produced, corresponding to [IDEA with  a  3T field](https://fcc-physics-events.web.cern.ch/fcc-ee/rec/spring2021/IDEA_3T?q=sim-type%3Ddelphes), and to "IDEA" where the Drift Chamber was repaced by the CLD tracker
...
- List of samples produced is [here](https://fcc-physics-events.web.cern.ch/fcc-ee/rec/winter2023?q=sim-type%3Ddelphes). More samples, esp. at 91 GeV, will be produced.
