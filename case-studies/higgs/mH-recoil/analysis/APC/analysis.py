...
class analysis():
    ...
    def run(self):
        df2 = (self.df
               ...
               .Define('missingET_costheta', 'ReconstructedParticle::get_MET_costheta(missingET_px,missingET_py,missingET_pz,missingET_e)')
               #select muons on pT
               ...
               .Define("selected_muons_costheta",  "ReconstructedParticle::get_costheta(selected_muons)")
               ...
               .Define("zed_leptonic_costheta",  "ReconstructedParticle::get_costheta(zed_leptonic)")
