...
namespace ReconstructedParticle{
  ...
  //ROOT::VecOps::RVec<float> get_MET_costheta(ROOT::VecOps::RVec<Float_t> Px, ROOT::VecOps::RVec<Float_t> Py, ROOT::VecOps::RVec<Float_t> Pz);
  //float get_MET_costheta(Float_t Px, Float_t Py, Float_t Pz);
